    ...
    <div className="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2 ">
      ...
      <div className="form-control">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            className="input input-bordered w-full pl-10 py-2 rounded-lg
              focus:border-primary focus:outline-none focus:ring-1 transition-all"
          ...
          />
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className={`input input-bordered w-full pl-10 py-2 rounded-lg border
